            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex flex-col gap-y-4">
                        ...
                        <div :class="collections['today'] ? collections['today'].repeat_1hour ? 'bg-gray-100' : 'bg-emerald-200' : 'bg-gray-100'" class="rounded-lg px-4 py-3 w-full">
                            <div class="flex items-center gap-x-4">
                        ...
                        <div :class="collections['today'] ? collections['today'].repeat_8hours ? 'bg-gray-100' : 'bg-emerald-200' : 'bg-gray-100'" class="rounded-lg px-4 py-3 w-full">
                            <div class="flex items-center gap-x-4">
